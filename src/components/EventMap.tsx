...
const booths: Booth[] = [
  ...
  { id: 7, position: [-5, 0, -34], size: [2, 1.5, 2], name: "株式会社ふくれん", description: "北海道音更産の産直ユキホマレ大豆を使用した無調整豆乳です。原材料は大豆と水のみのため、ユキホマレ大豆本来のほんのりとした甘みが味わえます。組合員さんの「小さいサイズが欲しい!」とのお声に応えて9月から200mlサイズが発売となりました", link: "https://example.com/booth6", image: "/images/booth7-1.jpg?height=100&width=100", image2: "/images/booth7-2.jpg?height=100&width=100" },  
  { id: 6, position: [-2, 0, -34], size: [3, 1.5, 2], name: "お魚食べようブース", description: "ブースでは「さかなっつハイ！」をご紹介！いわしを砂糖などで味付けしてゴマをまぶし、アーモンドと小粒ピーナツをミックスしています。景品でもらってお魚食べよう！", link: "https://example.com/booth7", image: "/images/booth6-1.jpg?height=100&width=100", image2: "/images/booth6-2.jpg?height=100&width=100" },  
  { id: 5, position: [1, 0, -34], size: [2, 1.5, 2], name: "平田産業有限会社", description: "国際産直産地は南オーストラリア州カンガルー島の非遺伝子組換え菜種のみを使用したこだわりの菜種油です。製法も圧搾一番搾りを湯洗い製法で行っておりますので、化学溶剤は一切使用しておりません。揚げ物はカラッと揚がり、胸やけしにくいのが特徴です。", link: "https://example.com/booth8", image: "/images/booth5-1.jpg?height=100&width=100", image2: "/images/booth5-2.jpg?height=100&width=100" },  
  { id: 4, position: [4, 0, -34], size: [2, 1.5, 2], name: "北海道漁業協同組合連合会", description: "産直産地野付漁協のほたては大きくて甘味があるのが特徴です。世界遺産知床半島沖の栄養豊富な水が、野付と国後島の狭い野付水道に流れ込むことにより、大きく甘いほたてが育ちます。プリプリ食感ととろける甘味をご堪能いただけます。", link: "https://example.com/booth9", image: "/images/booth4-1.jpg?height=100&width=100", image2: "/images/booth4-2.JPG?height=100&width=100" },
  { id: 3, position: [7, 0, -34], size: [2, 1.5, 2], name: "水宗園本舗", description: "「うまか有機銘茶会」が土づくりからこだわって育てた有機茶葉を使用。素材の持ち味を生かした深いうまみとコク、美しい水色をお楽しみください。", link: "https://example.com/booth10", image: "/images/booth3-1.jpg?height=100&width=100", image2: "/images/booth3-2.jpg?height=100&width=100" },  
  { id: 2, position: [10, 0, -34], size: [2, 1.5, 2], name: "JPホームサプライ株式会社", description: "シングル品は130m、ダブル品は65mと一般的なトイレットペーパーより長巻です。また、シングル品は太穴タイプと細穴タイプがございます。組合員様宅より出された牛乳パック等を原料として製造しております。", link: "https://example.com/booth11", image: "/images/booth2-1.jpg?height=100&width=100", image2: "/images/booth2-2.jpeg?height=100&width=100" },  
  { id: 1, position: [15, 0, -34], size: [6, 1.5, 2], name: "ヱスケー石鹸株式会社", description: "パルシステム群馬の組合員が開発に協力！洗浄力が高い “衣類用部分洗い石けんです。「子どもからおとなまで楽しく使える！」をテーマに、成分や香り、石けんのサイズや形状にまでこだわりを詰め込みました。 固形石けんを使ったことのない方も、この商品からぜひお試しください。環境にも人にもやさしい洗濯が楽しくなる石けんです。", link: "https://example.com/booth12", image: "/images/booth1-1.jpg?height=70&width=70", image2: "/images/booth1-2.jpg?height=70&width=70" },
    
  // 左列（5ブース）
  { id: 13, position: [-27, 0, -28], size: [2, 1.5, 6], name: "株式会社スクロール", description: "スクロールは全国の生協様に衣料品・靴、バッグといった服飾雑貨商品を販売しているアパレルメーカーです！当日は普段触れないお洋服の展示はもちろん、親子で楽しめるオリジナルエコバッグ作り体験を実施いたします！", link: "https://www.scroll-fan.com/", image: "/images/booth13-1.jpg?height=100&width=100", image2: "/images/booth13-2.jpg?height=100&width=100" },  
  ...
  // 中央セクション（1列目：12ブース）
  { id: 25, position: [-21, 0, -20], size: [2, 1.5, 2], name: "三菱食品㈱", description: "産直豚肉、産直キャベツを使い、飽きの来ないシンプルな味付けで組合員様から長年愛されている餃子にしよう!。来年で発売から20年を迎える人気商品です。当日会場で焼き立てを是非お召し上がりください。", link: "https://example.com/booth18", image: "/images/booth25-1.jpg?height=100&width=100", image2: "/images/booth25-2.jpg?height=100&width=100" },  
  { id: 24, position: [-18, 0, -20], size: [2, 1.5, 2], name: "日東富士製粉株式会社", description: "北海道産の産直小麦を使用したホットケーキミックスです。ふっくらとしたやわらかい食感と、優しい甘さのシンプルな配合が好評のロングセラー商品です。", link: "https://example.com/booth19", image: "/images/booth24-1.JPG?height=100&width=100", image2: "/images/booth24-2.JPG?height=100&width=100" },  
  { id: 23, position: [-15, 0, -20], size: [2, 1.5, 2], name: "21世紀コーヒー株式会社", description: "パルシステム群馬の組合員のみなさまにも大変ご好評をいただいている定番のブレンドコーヒーです。20g2個組で毎日使いに便利です。味と価格のバランスを追求したロングセラー（20年以上継続販売）商品です。", link: "https://example.com/booth20", image: "/images/booth23-1.jpg?height=100&width=100", image2: "/images/booth23-2.jpg?height=100&width=100" },  
  ...
  { id: 15, position: [14, 0, -20], size: [2, 1.5, 2], name: "株式会社高山", description: "産直小麦をはじめ国産原料のみで焼き上げ、シンプルなおいしさを追求。パルシステム埼玉商品開発チームの「自分たちが知っている原材料だけのカステラがほしい」という願いのもと、添加物の力に頼らないカステラができました。", link: "https://example.com/booth28", image: "/images/booth15-1.jpg?height=100&width=100", image2: "/images/booth15-2.jpg?height=100&width=100" },  
  { id: 14, position: [17, 0, -20], size: [2, 1.5, 2], name: "株式会社東京コールドチェーン", description: "フィリピン産のマンゴーを一口サイズにカットしました。忙しい朝のフルーツデザート、お子様のおやつなど、いろいろな場面でいつでもすぐに準備いらずに食べることができます。凍ったまま牛乳とミキサーにかければマンゴースムージーに！乳製品との相性も良くオススメです。", link: "https://example.com/booth29", image: "/images/booth14-1.jpg?height=100&width=100", image2: "/images/booth14-3.jpg?height=100&width=100" },
  ...
  { id: 40, position: [10, 0, -2], size: [3, 1.5, 2], name: "仲間づくりブース", description: "パルシステムをはじめたい！というお友だちといっしょにご来場のみなさまは、こちらのブースにお越しください！当日限定のご加入特典を準備してお待ちしております！", link: "https://example.com/booth46", image: "/images/booth40-1.jpg?height=100&width=100", image2: "/images/booth40-2.jpg?height=100&width=100" },
  { id: 95, position: [15, 0, -2], size: [6, 1.5, 4], name: "ステージ", description: "ステージevent", link: "https://example.com/booth47", image: "/images/booth95-1.jpg?height=100&width=100", image2: "/images/booth95-2.jpg?height=100&width=100" },
  ...
  // 右列（4ブース）
  { id: 44, position: [25, 0, -28], size: [2, 1.5, 2], name: "総合案内", description: "「商品展示会2024」に関する案内ブースです。お困りのことやご質問などございましたら、こちらのブースにお越しください。", link: "https://example.com/booth49", image: "/images/booth44-1.jpg?height=100&width=100", image2: "/images/booth44-2.jpg?height=100&width=100" },
  { id: 43, position: [25, 0, -20], size: [2, 1.5, 2], name: "商品アンテナブース", description: "商品アンテナ", link: "https://example.com/booth50", image: "/images/booth43-1.jpg?height=100&width=100", image2: "/images/booth43-2.jpg?height=100&width=100" },
  { id: 42, position: [25, 0, -16], size: [2, 1.5, 2], name: "共済ブース", description: "共済ブース", link: "https://example.com/booth51", image: "/images/booth42-1.jpg?height=100&width=100", image2: "/images/booth42-2.jpg?height=100&width=100" },
  { id: 96, position: [25, 0, -6], size: [2, 1.5, 2], name: "東毛酪農ブース", description: "パルシステム群馬でもおなじみの「東毛酪農のびん牛乳」が購入できるブースです。いつもよりお得な価格で購入できるのでぜひブースにお越しください！", link: "https://example.com/booth52", image: "/images/booth96-1.JPG?height=100&width=100", image2: "/images/booth96-2.jpg?height=100&width=100" },
  { id: 39, position: [19, 0, -34], size: [2, 1.5, 2], name: "商品開発チーム", description: "商品開発チーム", link: "https://example.com/booth52", image: "/images/booth39-1.jpg?height=100&width=100", image2: "/images/booth96-2.jpg?height=100&width=100" },

  // フードドライブ・トイレ・授乳室
  { id: 45, position: [25, 0, 1], size: [2, 1.5, 2], name: "フードドライブブース", description: "フードドライブ", link: "https://example.com/booth52", image: "/images/booth45-1.JPG?height=100&width=100", image2: "/images/booth45-2.JPG?height=100&width=100" },
  { id: 46, position: [-20, 0, 1], size: [2, 1.5, 2], name: "授乳室", description: "授乳室です。ご利用ください！", link: "https://example.com/booth52", image: "/images/booth96-1.jpg?height=100&width=100", image2: "/images/booth96-2.jpg?height=100&width=100" },
  { id: 101, position: [-25, 0, 1], size: [7, 1.5, 2], name: "女性用トイレ", description: "女性用トイレです。", link: "https://example.com/booth52", image: "/images/booth101-1.jpg?height=100&width=100", image2: "/images/booth101-2.jpg?height=100&width=100" },
  { id: 102, position: [-12, 0, 1], size: [8, 1.5, 2], name: "男性用トイレ", description: "男性用トイレです。", link: "https://example.com/booth52", image: "/images/booth102-1.jpg?height=100&width=100", image2: "/images/booth102-2.jpg?height=100&width=100" },

    
  // お仕事ブース
  { id: 47, position: [27, 0, 17], size: [7, 1.5, 7], name: "お仕事体験ブース", description: "パルシステムのお仕事体験ができるよ！パルシステムの配達員になりきって、パパやママに商品を届けてみよう", link: "https://example.com/booth52", image: "/images/booth47-1.JPG?height=100&width=100", image2: "/images/booth47-2.JPG?height=100&width=100" },
...
function createFirework(position: THREE.Vector3, color: number) {
...
// 花火を更新する関数
function updateFirework(firework: THREE.Points, deltaTime: number) {
  const positions = firework.geometry.attributes.position.array as Float32Array
  const velocities = firework.geometry.attributes.velocity.array as Float32Array
  const colors = firework.geometry.attributes.color.array as Float32Array
