...
export default function Component() {
    ...
    return (_jsxs("div", { style: { position: 'relative', width: '100%', height: '100vh' }, children: [_jsx("div", { ref: mountRef, style: { width: '100%', height: '100%' } }), selectedBooth && (_jsxs("div", { style: {
            ...
            _jsxs(_Fragment, { children: [_jsx("a", { href: "https://www.palsystem-gunma.coop/", target: "_blank", style: {
                            position: 'absolute',
                            ...
                            zIndex: 5, // モーダルより下に表示
                        }, onMouseEnter: (e) => e.currentTarget.style.transform = 'scale(1.05)', onMouseLeave: (e) => e.currentTarget.style.transform = 'scale(1)', children: "\u3059\u3079\u3066\u306E\u30E1\u30FC\u30AB\u30FC\u30D6\u30FC\u30B9\u8A73\u7D30\u306F\u3053\u3061\u3089" }), _jsx("a", { href: "https://example.com/survey", target: "_blank", style: {
                            position: 'absolute',
                            bottom: '10px',
                            right: '10px',
                            padding: '6px 12px',
