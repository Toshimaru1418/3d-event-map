...
const booths = [
    ...
    { id: 3, position: [7, 0, -34], size: [2, 1.5, 2], name: "㈱水宗園本舗", description: "「うまか有機銘茶会」が土づくりからこだわって育てた有機茶葉を使用。素材の持ち味を生かした深いうまみとコク、美しい水色をお楽しみください。", hasLink: true, link: "https://forms.gle/h5DLVLqZLLykifCJ8", image: "/images/booth3-1.webp?height=100&width=100", image2: "/images/booth3-2.webp?height=100&width=100" },
    ...
    { id: 19, position: [-3, 0, -20], size: [2, 1.5, 2], name: "ホクレン農業協同組合連合会", description: "北海道根釧地区の生乳だけを、新鮮なうちにパック。パックした翌々日に組合員のもとへ届きます。HTST殺菌法（72℃・15秒殺菌）で生乳本来の風味やコクを大切した牛乳です。", hasLink: true, link: "https://forms.gle/h5DLVLqZLLykifCJ8", image: "/images/booth19-1.webp?height=100&width=100", image2: "/images/booth19-2.webp?height=100&width=100" },
    ...
    { id: 31, position: [-9, 0, -16], size: [2, 1.5, 2], name: "エム・シーシー食品㈱", description: "産直バジルのジェノベーゼソーは、朝摘み・手摘みにこだわった香りと彩りのよいバジルを使用し、シンプルかつ味わい深く仕上げたこだわりのパスタソースです。", hasLink: true, link: "https://forms.gle/h5DLVLqZLLykifCJ8", image: "/images/booth31-1.webp?height=100&width=100", image2: "/images/booth31-2.webp?height=100&width=100" },
    ...
    { id: 26, position: [12, 0, -16], size: [2, 1.5, 2], name: "榛名直販㈱", description: "群馬県産の生乳を使用した、生乳70%のむヨーグルト。余計なものは使用せず、生乳、砂糖、脱脂粉乳のみを使用した、安心して毎日でも飲みたいのむヨーグルトです。", hasLink: true, link: "https://forms.gle/h5DLVLqZLLykifCJ8", image: "/images/booth26-1.webp?height=100&width=100", image2: "/images/booth26-2.webp?height=100&width=100" },
    // 中央下段セクション（1ブース）
...
export default function Component() {
    ...
    const [imageScale, setImageScale] = useState(1.0); // 画像のスケール
    // ローディング状態とエラーメッセージのためのステートを追加
    const [isLoading, setIsLoading] = useState(true);
    const [error, setError] = useState(null);
    const [showMap, setShowMap] = useState(false); // マップを表示するかの状態
    useEffect(() => {
        if (!mountRef.current || !showMap)
            return; // showMapがtrueの時だけ3Dマップを初期化
        // テキストを作るための関数を追加
        ...
        booths.forEach((booth) => {
            ...
            // ここにテキストスプライトを追加します
            const textSprite = createTextSprite(booth.name, // ブース名
        ...
        function createBooth(booth) {
            ...
            if (booth.id === 200) {
                // id:200のブースの天面に画像を適用
                textureLoader.load('/images/map/eventmap_info.webp', (texture) => {
    ...
    return (_jsx("div", { children: !showMap ? (_jsx(Instructions, { onShowMap: () => setShowMap(true) }) // showMapがfalseならInstructionsを表示
        ) : (_jsxs("div", { style: { position: 'relative', width: '100%', height: '100vh' }, children: [_jsx("div", { ref: mountRef, style: { width: '100%', height: '100%' } }), isLoading && _jsx("p", { children: "\u30DE\u30C3\u30D7\u3092\u8AAD\u307F\u8FBC\u3093\u3067\u3044\u307E\u3059..." }), error && _jsxs("p", { children: ["\u30A8\u30E9\u30FC: ", error] }), selectedBooth && (_jsxs("div", { style: {
                        position: 'absolute',
                        top: '16px',
                        left: '14px',
                        background: 'white',
                        ...
                        zIndex: 10, // モーダルを前面に
                                ...
                                textDecoration: 'none',
                                marginTop: '10px',
                            }, children: "\u6CE8\u6587\u3059\u308B" }))] })), selectedBooth && (_jsxs("div", { style: {
                        position: 'absolute',
                        top: '16px',
                        left: '14px',
                        background: 'white',
                        ...
                        zIndex: 10,
                                ...
                                textDecoration: 'none',
                                marginTop: '10px',
                            }, children: "\u6CE8\u6587\u3059\u308B" }))] })), !selectedBooth && (_jsxs(_Fragment, { children: [_jsx("a", { href: "https://www.palsystem-gunma.coop/posts/?id=2024expo-makerinfo", target: "_blank", style: {
                                position: 'absolute',
                                bottom: '80px',
                                right: '10px',
                                padding: '6px 12px',
                                ...
                                zIndex: 20,
                            }, onMouseEnter: (e) => e.currentTarget.style.transform = 'scale(1.05)', onMouseLeave: (e) => e.currentTarget.style.transform = 'scale(1)', children: "\u3059\u3079\u3066\u306E\u30E1\u30FC\u30AB\u30FC\u30D6\u30FC\u30B9\u8A73\u7D30\u306F\u3053\u3061\u3089" }), _jsx("a", { href: "https://forms.gle/PhDiqVmncdAo14rKA", target: "_blank", style: {
                                position: 'absolute',
                                bottom: '45px',
                                right: '10px',
                                padding: '6px 12px',
                                ...
                                transition: 'transform 0.2s ease-in-out',
                                zIndex: 20,
                            }, onMouseEnter: (e) => e.currentTarget.style.transform = 'scale(1.05)', onMouseLeave: (e) => e.currentTarget.style.transform = 'scale(1)', children: "\u5546\u54C1\u5C55\u793A\u4F1A\u30A2\u30F3\u30B1\u30FC\u30C8\u306F\u3053\u3061\u3089\u304B\u3089" }), _jsx("a", { href: "https://forms.gle/h5DLVLqZLLykifCJ8", target: "_blank", style: {
                                position: 'absolute',
                                bottom: '10px',
                                right: '10px',
                                padding: '6px 12px',
                                ...
                                transition: 'transform 0.2s ease-in-out',
                                zIndex: 20,
                            }, onMouseEnter: (e) => e.currentTarget.style.transform = 'scale(1.05)', onMouseLeave: (e) => e.currentTarget.style.transform = 'scale(1)', children: "\u5546\u54C1\u306E\u6CE8\u6587\u306F\u3053\u3061\u3089\u304B\u3089\u3082\u3067\u304D\u307E\u3059\uFF01" })] }))] })) }));
}
