...
export default function Component() {
    ...
    return (_jsxs("div", { style: { position: 'relative', width: '100%', height: '100vh' }, children: [_jsx("div", { ref: mountRef, style: { width: '100%', height: '100%' } }), selectedBooth && (_jsxs("div", { style: {
            ...
            _jsxs(_Fragment, { children: [_jsx("a", { href: "https://www.palsystem-gunma.coop/posts/?id=2024expo-makerinfo", target: "_blank", style: {
                            ...
                            transition: 'transform 0.2s ease-in-out',
                            zIndex: 5, // モーダルより下に表示
                        }, onMouseEnter: (e) => e.currentTarget.style.transform = 'scale(1.05)', onMouseLeave: (e) => e.currentTarget.style.transform = 'scale(1)', children: "\u5546\u54C1\u5C55\u793A\u4F1A\u30A2\u30F3\u30B1\u30FC\u30C8\u306F\u3053\u3061\u3089\u304B\u3089" })] }))] }));
}
